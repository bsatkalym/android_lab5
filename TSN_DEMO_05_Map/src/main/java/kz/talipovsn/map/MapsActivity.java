...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng marker3 = new LatLng(52.254778, 76.947305); // Маркер Ясмин
    static final LatLng marker4 = new LatLng(52.255243, 76.945076); // Маркер Инмарт
    static final LatLng marker5 = new LatLng(52.252409, 76.946181); // Маркер Арбат
    static final LatLng marker6 = new LatLng(52.256722, 76.949322); // Маркер Монолит
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title(getString(R.string.marker3_title)).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.jasmin)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title(getString(R.string.marker5_title)).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.arbat)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker6).title(getString(R.string.marker6_title)).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.monolit)).alpha(ALPHA).
    ...
    // Четвертый пункт
    public void onClickTest(View viev) {
        mMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
    }

    public void onClickTest1(View viev) {
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
    }

    public void onClickTest2(View viev) {
